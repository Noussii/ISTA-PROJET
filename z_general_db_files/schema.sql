DROP database if EXISTS ista_website_db;


-- MySQL Script generated by MySQL Workbench
-- Wed Jun  7 19:36:50 2023
...
CREATE TABLE IF NOT EXISTS `ista_website_db`.`announcement` (
  ...
  INDEX `fk_anouncement_teacher_idx` (`teacher_id` ASC) ,
  INDEX `fk_anouncement_class_idx` (`class_id` ASC) ,
  INDEX `fk_anouncement_subject_idx` (`subject_id` ASC) ,
  CONSTRAINT `fk_anouncement_teacher`
    FOREIGN KEY (`teacher_id`)
    REFERENCES `ista_website_db`.`teacher` (`teacher_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_anouncement_class`
    FOREIGN KEY (`class_id`)
    REFERENCES `ista_website_db`.`class` (`class_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_anouncement_subject`
    FOREIGN KEY (`subject_id`)
    REFERENCES `ista_website_db`.`subject` (`subject_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
